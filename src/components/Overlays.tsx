...
const SPLASH_KEY = "dnf-splash-seen";
...
/** Launch screen: the doughnut mark draws itself in, then the app fades up. */
...
export function SuccessScreen({ open, title, tone = "success", onDone }: SuccessProps) {
  ...
  const blobs =
    tone === "success"
      ? [
          { c: "#e9c67e", x: "-20%", y: "-10%", s: "70vmax" },
          { c: "#d6bde8", x: "35%", y: "30%", s: "65vmax" },
          { c: "#cadfef", x: "-10%", y: "55%", s: "55vmax" },
        ]
      : [
          { c: "#e8d2ae", x: "-20%", y: "-10%", s: "70vmax" },
          { c: "#d6bde8", x: "35%", y: "35%", s: "60vmax" },
          { c: "#cbaab4", x: "-15%", y: "55%", s: "55vmax" },
        ];
